...
/* Mockup card with floating badge and float animation */
  ...
  <div style={{ position: "relative", maxWidth: 460 }}>
    ...
    >
      ...
      <div style={{ padding: 20 }}>
        ...
        {/* Citation cards */}
        <MockupCitationCard
          code="NYC Admin Code § 27-2029"
          text="Landlords must maintain minimum 68°F during heating season..."
          score="✓ 96%"
        />
        <div style={{ marginTop: 8 }} />
        <MockupCitationCard
          code="Housing Maintenance Code § 27-2033"
          text="Violations carry fines up to $1,000 per day..."
          score="✓ 91%"
        />
...
const MockupCitationCard: React.FC<CitationCardProps> = ({ code, text, score }) => (
  <div
    style={{
